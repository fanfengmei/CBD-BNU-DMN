...
n = 100;  % The number of generated random networks
randtype = 1;
% randtype = 1: The random matrix was generated using a modified Maslov's wiring program (Maslov and Sneppen 2002).
% When the edges are randomly rewired, their weights are not changed (default).
% randtype = 2: The random matrix was generated using a modified Maslov's wiring program (Maslov and Sneppen 2002).
